...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~PmAmRJAS#n0UyN0lsdnk9UCkjas_KOAzRbw7Bjgoq28qgBAShS4o", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "MR-BALOCH", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "MR-BALOCH", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "MR-BALOCH💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "MR-BALOCH", // Input Yours custom...(Maintain font for Flow)
